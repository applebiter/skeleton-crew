"""
GUI widgets for skeleton-app.
"""

__all__ = ["TransportPanel", "ClusterPanel", "PatchbayWidget", "NodeCanvasWidget", "VideoPanel"]
...
from skeleton_app.gui.widgets.node_canvas_v2 import NodeCanvasWidget
